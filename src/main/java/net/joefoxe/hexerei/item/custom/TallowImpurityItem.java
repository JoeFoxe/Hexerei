...
//        }
    ...
    public void addInformation(ItemStack stack, @Nullable World world, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        if(Screen.hasShiftDown()) {
            tooltip.add(new TranslationTextComponent("tooltip.hexerei.tallow_impurity_shift"));
        } else {
            tooltip.add(new TranslationTextComponent("tooltip.hexerei.tallow_impurity"));
        }
