...
//            () -> new Block(AbstractBlock.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(5f)));
    ...
    public static final RegistryObject<Block> MIXING_CAULDRON = registerBlock("mixing_cauldron",
            () -> new MixingCauldron(AbstractBlock.Properties.create(Material.IRON).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(4f).setLightLevel(state -> 12)));
    ...
    public static final RegistryObject<Block> HERB_JAR = registerBlock("herb_jar",
            () -> new HerbJar(AbstractBlock.Properties.create(Material.GLASS).harvestLevel(0).hardnessAndResistance(0.5f)));
    ...
    public static final RegistryObject<Block> CANDLE = registerBlock("candle",
            () -> new Candle(AbstractBlock.Properties.create(Material.GOURD).doesNotBlockMovement().notSolid().harvestLevel(0).hardnessAndResistance(0.5f).setLightLevel(state -> Math.min(state.get(Candle.CANDLES_LIT) * 12, 15))));

    public static final RegistryObject<Block> CANDLE_BLUE = registerBlock("candle_blue",
            () -> new Candle(AbstractBlock.Properties.create(Material.GOURD).doesNotBlockMovement().notSolid().harvestLevel(0).hardnessAndResistance(0.5f)));
    ...
    public static final RegistryObject<Block> MAHOGANY_LEAVES = registerBlock("mahogany_leaves",
            () -> new LeavesBlock(AbstractBlock.Properties.from(Blocks.OAK_LEAVES).tickRandomly().sound(SoundType.PLANT).notSolid().harvestTool(ToolType.HOE).setSuffocates(Properties::never).setBlocksVision(Properties::never)));
    ...
    public static final RegistryObject<Block> LILY_PAD_BLOCK = registerBlockNoItem("flowering_lily_pad",
            () -> new FloweringLilyPadBlock(AbstractBlock.Properties.create(Material.PLANTS).zeroHardnessAndResistance().sound(SoundType.LILY_PADS).notSolid()));
    ...
    public static final RegistryObject<Block> CANDLE_DIPPER = registerBlock("candle_dipper",
            () -> new CandleDipper(AbstractBlock.Properties.create(Material.IRON).doesNotBlockMovement().notSolid().harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(8f)));
    ...
    public static final RegistryObject<Block> CANDLE_DIPPER_WICK_BASE = registerBlockNoItem("candle_dipper_wick_base",
            () -> new Block(AbstractBlock.Properties.create(Material.IRON).harvestLevel(0).doesNotBlockMovement().hardnessAndResistance(1f)));

    public static final RegistryObject<Block> CANDLE_DIPPER_WICK = registerBlockNoItem("candle_dipper_wick",
            () -> new Block(AbstractBlock.Properties.create(Material.GOURD).harvestLevel(0).doesNotBlockMovement().hardnessAndResistance(1f)));
    ...
    public static final RegistryObject<Block> CANDLE_0_OF_7 = registerBlockNoItem("candle_0_of_7",
            () -> new Candle(AbstractBlock.Properties.create(Material.GOURD).harvestLevel(0).doesNotBlockMovement().hardnessAndResistance(1f)));
