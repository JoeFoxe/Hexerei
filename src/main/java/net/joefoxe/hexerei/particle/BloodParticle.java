...
//			RenderSystem.enableLighting();
    ...
    public BloodParticle(ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ) {
        ...
        this.colorOffset = (rand.nextFloat() * 0.25f);
    ...
    public void renderParticle(IVertexBuilder buffer, ActiveRenderInfo renderInfo, float partialTicks) {
        ...
        for (int i = 0; i < CUBE.length / 4; i++) {
            ...
            for (int j = 0; j < 4; j++) {
                ...
                vec = vec
                        .rotateYaw(this.rotation + this.rotationOffsetYaw)
                        .rotatePitch(this.rotation + this.rotationOffsetPitch)
                        .rotateRoll(this.rotation + this.rotationOffsetRoll)
                ...
                buffer.addVertex((float) vec.x, (float) vec.y, (float) vec.z, this.particleRed + this.colorOffset, this.particleGreen, this.particleBlue, this.particleAlpha, 0, 0, 0, light,(float) normal.x, (float) normal.y, (float) normal.z);
