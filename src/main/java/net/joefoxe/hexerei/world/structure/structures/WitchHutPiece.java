...
//
//
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 2,   0, -1, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), -8,  0, -1, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 4,   0, 1, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 2,   0, -5, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 4,   0, -5, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 4,   0, -11, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 4,   0, -17, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 0,   0, -14, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 2,   0, -14, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 2,   0, -10, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), -3,  0, -14, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), -8,  0, -14, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), -8,  0, -10, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), -8,  0, -5, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 0,   0, -17, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 0,   0, -21, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), -3,  0, -17, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), -3,  0, -21, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 7,   0, -6, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 7,   0, -9, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), -10, 0, 1, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), -10, 0, -5, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), -10, 0, -11, p_230383_5_);
//            this.replaceAirAndLiquidDownwards(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), -10, 0, -17, p_230383_5_);

            System.out.println(p_230383_5_);
//            p_230383_5_.
//            this.replaceAirAndLiquidDownwardsNoCheck(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 0, 3, 1, p_230383_5_);
////            this.replaceAirAndLiquidDownwardsNoCheck(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 1, 3, 0, p_230383_5_);
//            this.replaceAirAndLiquidDownwardsNoCheck(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), 1, 3, 1, p_230383_5_);

//            for(int i = 2; i <= 7; i += 5) {
//                for(int j = 1; j <= 5; j += 4) {
//                    this.replaceAirAndLiquidDownwardsNoCheck(p_230383_1_, Blocks.SPRUCE_LOG.getDefaultState(), j, 3, i, p_230383_5_);
//                }
//            }
