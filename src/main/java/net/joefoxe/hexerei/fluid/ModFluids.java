...
public class ModFluids {
    ...
    public static final ResourceLocation WATER_STILL_RL = new ResourceLocation(Hexerei.MOD_ID + ":block/quicksilver_still");
    public static final ResourceLocation WATER_FLOWING_RL = new ResourceLocation(Hexerei.MOD_ID + ":block/quicksilver_flow");
    public static final ResourceLocation WATER_OVERLAY_RL = new ResourceLocation(Hexerei.MOD_ID + ":block/quicksilver_overlay");
